                    ...
                    children: [
                      ...
                      Expanded(
                        child: Text(
                          ...
                          style: theme.textTheme.bodySmall?.copyWith(
                            color: isLightTheme ? const Color(0xFF008C86) : AppColors.primaryColor,
                            fontWeight: FontWeight.bold,
                            height: 1.4,
                          ),
                        ),
                      ...
                      child: ElevatedButton(
                        ...
                        child: FittedBox(
                          ...
                          child: Row(
                            ...
                            children: [
                              const Icon(Icons.emergency_outlined, size: 14),
                              const SizedBox(width: 4),
                              Text(
                                _showCrisisHelplines ? 'Hide Helplines' : 'Crisis Support',
                          ...
                          children: [
                            Expanded(
                              child: OutlinedButton.icon(
                                ...
                                label: const Text('Call 988', style: TextStyle(fontSize: 10)),
                            ...
                            Expanded(
                              child: OutlinedButton.icon(
                                ...
                                icon: const Icon(Icons.local_hospital, size: 14),
                                label: const Text('Call 911', style: TextStyle(fontSize: 10)),
                                style: OutlinedButton.styleFrom(
                                  foregroundColor: AppColors.errorColor,
                                  side: const BorderSide(color: AppColors.errorColor),
                                  padding: EdgeInsets.zero,
